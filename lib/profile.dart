                        ...
                        onPressed: (){
                          showDialog<void>(
                            ...
                            builder: (BuildContext dialogContext) {
                              return AlertDialog(
                                title: const Text('Confirmar', textAlign: TextAlign.start, style: TextStyle( color: Color(0xff2E3E5C))),
                                content: const Text('¿Quieres salir de la aplicación?', style: TextStyle( color: Color(0xff2E3E5C))),
                                actions: <Widget>[
                                  TextButton(
